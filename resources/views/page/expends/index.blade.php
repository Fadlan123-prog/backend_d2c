                                ...
                                <tbody>
                                    @foreach ($expends as $expend)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('expends.edit', $expend->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                    Edit
                                                </a>
                                                <button type="button" class="border-0 bg-transparent text-secondary font-weight-bold text-xs px-2" data-bs-toggle="modal" data-bs-target="#modal-notification-{{ $expend->id }}">
                                                ...
                                                <div class="modal fade" id="modal-notification-{{ $expend->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
