                ...
                <form action="{{ route('items.list.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="item[items_name]" value="{{ old('item.items_name') }}" class="form-control" id="items_name" placeholder="Nama Item">
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                    ...
                    <div class="row" id="hargaItemContainer">
                        <div class="col-xl-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="item[harga_item]" value="{{ old('item.harga_item') }}" class="form-control" id="harga_item" placeholder="Harga Item">
                            </div>
                        </div>
                    </div>
