...
<div class="row">
    <div class="col-xl-3 col-sm-3">
        <a href="{{ route('items.list.create') }}">
            <button type="button" class="btn bg-black">Add Item</button>
        </a>
    </div>
</div>
            ...
            <div class="table-responsive">
                <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-xs">{{ $item->items_name }}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <p class="text-xs font-weight-bold mb-0">{{ $item->category->categories_name }}</p>
                            </td>
                            <td>
                        ...
                        <tr id="sizes{{ $item->id }}" class="collapse">
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-xs">{{ $size->size }}</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td></td>
                                                    <td>
                                                        <span class="text-secondary text-xs font-weight-bold">{{ formatRupiah($size->pivot->price) }}</span>
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                    <td>
                                                        <a href="{{ route('items.edit', $item->id )}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                            Edit
                                                        </a>
                                                        <button type="button" class="border-0 bg-transparent text-secondary font-weight-bold text-xs px-2" data-bs-toggle="modal" data-bs-target="#modal-notification-{{ $item->id }}">
                        ...
                        @else
                            <tr>
                                ...
                                <td>
                                    <span class="text-secondary text-xs font-weight-bold">{{ formatRupiah($item->harga_item) }}</span>
                                </td>
                                <td>
