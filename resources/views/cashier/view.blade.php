                                         ...
                                         <div class="card bg-black text-white rounded-3">
                                             <div class="card-body">
                                                 ...
                                                 <div class="d-flex justify-content-between">
                                                     ...
                                                     <p class="mb-2" id="subtotal">Rp 0</p>
                                                 </div>
                                                 <form class="mt-4">
                                                     <div class="form-outline form-white mb-4">
                                                       <input type="text" id="typeName" class="form-control form-control-lg" size="17"
                                                         placeholder="Input Nominal" />
                                                       <label class="form-label" for="typeName">Input Nominal</label>
                                                     </div>
                                                   </form>
                                                   <div class="row">
                                                    <div class="col-12 mb-3">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="btn-group" role="group">
                                                                <button type="button" class="btn btn-info btn-sm">Transfer</button>
                                                                <button type="button" class="btn btn-info btn-sm">Tokopedia</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                  </div>
                                                   <div class="row">
                                                     <div class="col-12 mb-3">
                                                         <div class="d-flex justify-content-between">
                                                             <div class="btn-group" role="group">
                                                                 <button type="button" class="btn btn-info btn-sm">10000</button>
                                                                 <button type="button" class="btn btn-info btn-sm">50000</button>
                                                                 <button type="button" class="btn btn-info btn-sm">100000</button>
                                                             </div>
                                                         </div>
                                                     </div>
                                                   </div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <form class="mt-4">
                                                              ...
                                                              <div class="row mb-3">
                                                                <div class="col-12">
                                                                    <div class="btn-group" role="group">
                                                                        <button type="button" class="btn btn-info btn-sm" data-value="10000">10000</button>
                                                                        <button type="button" class="btn btn-info btn-sm" data-value="50000">50000</button>
                                                                        <button type="button" class="btn btn-info btn-sm" data-value="100000">100000</button>
                                                                    </div>
                                                                </div>
                                                              </div>
